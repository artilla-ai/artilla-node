...
describe('instantiate client', () => {
  ...
  describe('defaultQuery', () => {
    test('with null query params given', () => {
      const client = new Artilla({ baseURL: 'http://localhost:5000/', defaultQuery: { apiVersion: 'foo' } });
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Artilla({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Artilla({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Artilla({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    afterEach(() => {
      process.env['ARTILLA_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Artilla({ baseURL: 'https://example.com' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Artilla({ maxRetries: 4 });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Artilla({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Artilla({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Artilla({ fetch: testFetch });

...
export class Users extends APIResource {
  ...
  referral(
    referralCode: string,
    params?: UserReferralParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<UserReferralResponse>;
  referral(referralCode: string, options?: Core.RequestOptions): Core.APIPromise<UserReferralResponse>;
  referral(
    referralCode: string,
    params: UserReferralParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<UserReferralResponse> {
    if (isRequestOptions(params)) {
      return this.referral(referralCode, {}, params);
    }
    const { authorization, 'x-api-key': xAPIKey } = params;
...
export interface UserReferralResponse {
  ...
  user: UserReferralResponse.User;
}

export namespace UserReferralResponse {
  export interface User {
    image: string | null;
...
export interface UserReferralParams {
  /**
   * This is your JWT tolen
   */
  authorization?: string;
...
export namespace Users {
  ...
  export import UserReferralResponse = UsersAPI.UserReferralResponse;
  export import UserMeParams = UsersAPI.UserMeParams;
  export import UserOnboardingParams = UsersAPI.UserOnboardingParams;
  export import UserReferralParams = UsersAPI.UserReferralParams;
}

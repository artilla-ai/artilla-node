# Artilla Node API Library

[![NPM version](https://img.shields.io/npm/v/artilla.svg)](https://npmjs.org/package/artilla) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/artilla)

This library provides convenient access to the Artilla REST API from server-side TypeScript or JavaScript.

The REST API documentation can be found on [docs.artilla.com](https://docs.artilla.com). The full API of this library can be found in [api.md](api.md).
...
add the following import before your first import `from "Artilla"`:
...
- Deno v1.28.0 or higher, using `import Artilla from "npm:artilla"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
